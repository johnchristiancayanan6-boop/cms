...
import com.eastwest.dto.imports.LocationImportDTO;
...
import com.eastwest.repository.LocationRepository;
...
public class LocationService {
    ...
    private void checkUsageBasedLimit(Company company) {
        // License check removed - all features are now free, no limits
    }
