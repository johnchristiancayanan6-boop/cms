...
import com.eastwest.repository.PreventiveMaintenanceRepository;
...
public class PreventiveMaintenanceService {
    ...
    private void checkUsageBasedLimit(Company company) {
        // LICENSE REMOVED: No longer checking UNLIMITED_PM_SCHEDULES entitlement
        // All PM schedule creation is now unlimited
    }
