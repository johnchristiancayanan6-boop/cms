# Eastwest CMMS Mobile App

This project aims to help manage assets, schedule maintenance and track work orders. This is the mobile app developed
with React Native.
You can use the [live app](https://play.google.com/store/apps/details?id=com.eastwest.cmms) and configure it with your custom server url, or build the app locally
