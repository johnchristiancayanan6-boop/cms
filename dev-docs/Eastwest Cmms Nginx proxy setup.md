# Eastwest CMMS NGINX proxy manager setup guide
...
- `maint.domain.com` → Access your Eastwest CMMS instance
...
Restart your Docker containers or restart the entire Eastwest CMMS host/VM.
